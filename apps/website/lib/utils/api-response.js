...
export function errorResponse(message, code, details) {
  return {
    success: false,
    error: {
      message,
...
/**
 * Convert custom error to response format
 */
 ...
 */
export function formatValidationErrors(zodErrors) {
 ...
 */
export function validationErrorResponse(zodErrors) {
