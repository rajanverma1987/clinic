...
import { ADMIN_REPORTS_CHILDREN } from '@/lib/constants/dashboard-structure';
...
export default function AdminReportsPage() {
  ...
  return (
    <Layout title={t('admin.reportsAndAnalytics')} subtitle={t('admin.reportsHubSubtitle')}>
      <div className='admin-hub-content'>
        <div className='admin-hub-grid'>
          {ADMIN_REPORTS_CHILDREN.map(({ path, labelKey, descKey }) => (
