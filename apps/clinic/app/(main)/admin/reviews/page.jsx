...
import { ADMIN_REVIEWS_CHILDREN } from '@/lib/constants/dashboard-structure';
...
export default function AdminReviewsPage() {
  ...
  return (
    <Layout
      ...
      subtitle={t('admin.reviewsHubSubtitle')}
    >
      <div className='admin-hub-content'>
        <div className='admin-hub-grid'>
          {ADMIN_REVIEWS_CHILDREN.map(({ path, labelKey, descKey }) => (
