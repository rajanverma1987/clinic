...
export default function TermsPage() {
  return (
    <div className='min-h-screen flex flex-col'>
      <Header />
      <main className='flex-1 pb-16 px-4 sm:px-6 lg:px-8' style={{ paddingTop: '120px' }}>
