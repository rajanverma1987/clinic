...
function saveHistory(data) {
  ...
  historicalData.trends.push({
    ...
    rawButtons: data.rawButtons.length,
    invalidVariants: data.invalidVariants.length,
    invalidSizes: data.invalidSizes.length,
    doubleBorders: data.doubleBorders.length,
  });
