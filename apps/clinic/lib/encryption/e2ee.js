...
export async function encryptMessage(message, key) {
  try {
    ...
    logger.error('[E2EE] Encryption error:', error);
...
export async function decryptMessage(encryptedData, key) {
  try {
    ...
    logger.error('[E2EE] Decryption error:', error);
...
export async function encryptFile(fileData, key) {
  try {
    ...
    logger.error('[E2EE] File encryption error:', error);
...
export async function decryptFile(encryptedData, ivBase64, key) {
  try {
    ...
    logger.error('[E2EE] File decryption error:', error);
