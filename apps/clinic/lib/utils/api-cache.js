/**
 * API Cache Utility – part of enterprise cache strategy (lib/cache/http-cache-strategy.js).
 * In-memory cache for API responses with TTL by endpoint and prefix invalidation.
 * Bounded by MAX_API_CACHE_ENTRIES; evicts oldest entries when full.
 * Used by apiClient for GET requests; call clearCacheByPrefix after mutations.
 */
