...
export const ROUTES = [
  ...
  },
  {
    ...
    requiredFeature: null,
    requiredPermission: { resource: RESOURCES.TASK, action: ACTIONS.READ },
    requiredRoles: [
      'doctor',
      'clinic_admin',
      'admin',
...
export const SETTINGS_CHILDREN = [
  ...
  { path: '/settings/consent', labelKey: 'settings.consentTemplates', adminOnly: true },
...
export const PAGE_EXTRA_DETAILS = {
  ...
  '/settings/consent': {
    parentPath: '/settings',
    descKey: 'settings.consentTemplates',
    order: 9,
    requiredFeature: null,
  },
  '/settings/locations': {
