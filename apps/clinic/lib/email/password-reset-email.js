  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .code-box { background: #fff; border: 3px solid ${PRIMARY_900}; padding: 20px; margin: 20px 0; border-radius: 8px; text-align: center; }
        .code { font-size: 32px; font-weight: bold; letter-spacing: 8px; color: ${PRIMARY_900}; font-family: monospace; }
