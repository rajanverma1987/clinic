        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='prose prose-lg max-w-none'>
            ...
            <section className='mb-8'>
              ...
              <p className='text-neutral-700 mb-4'>To use the Service, you must:</p>
              <ul className='list-disc pl-6 text-neutral-700 mb-4 space-y-2'>
            ...
            <section className='mb-8'>
              ...
              <ul className='list-disc pl-6 text-neutral-700 mb-4 space-y-2'>
                ...
                <li>
                  Use the Service to store or process data in violation of patient privacy rights
                </li>
              </ul>
            </section>
            ...
            <section className='mb-8'>
              ...
              <h3 className='text-xl font-semibold text-neutral-900 mb-3'>5.2 GDPR Compliance</h3>
              <p className='text-neutral-700'>
                ...
                appropriate consents and implementing data protection measures.
              </p>
            </section>
            ...
            <section className='mb-8'>
              <h2 className='text-2xl font-semibold text-neutral-900 mb-4'>7. Payment Terms</h2>
              <h3 className='text-xl font-semibold text-neutral-900 mb-3'>7.1 Subscription Fees</h3>
              <p className='text-neutral-700 mb-4'>
            ...
            <section className='mb-8'>
              ...
              <p className='text-neutral-700'>
                ...
                policies. You may request data export before termination.
              </p>
            </section>
