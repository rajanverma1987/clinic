    ...
    <Card className='dashboard-list-card dashboard-list-card-primary'>
      <div className='relative z-10 p-4 h-full flex flex-col'>
        ...
        <div className='section-header'>
          ...
          <h2 className='section-title'>Patients Summary {new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</h2>
        </div>
          ...
          <div className='relative' style={{ width: '200px', height: '200px' }}>
            ...
            <div className='absolute inset-0 flex items-center justify-center'>
              <div className='text-center'>
                ...
                <div className='text-body-xs text-neutral-500'>Total</div>
              </div>
            </div>
          </div>
          ...
          <div className='mt-6 space-y-3 w-full'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-body-sm text-neutral-700'>New Patients</span>
              </div>
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-body-sm text-neutral-700'>Old Patients</span>
              </div>
            ...
            <div className='flex items-center justify-between pt-2 border-t border-neutral-200'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-body-sm font-semibold text-neutral-900'>Total Patients</span>
              </div>
