        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Streamline your clinic management with our comprehensive healthcare platform.
            </p>
            ...
            <div className="mt-12 space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Enterprise-grade security for your patient data</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Access your clinic from anywhere, anytime</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 animate-slide-up hover-lift">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl mb-4 animate-bounce-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center group cursor-pointer">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-600 group-hover:text-gray-900 transition-colors flex items-center">
                ...
                <Link href="/forgot-password" className="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center group transition-colors">
