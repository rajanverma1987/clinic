              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {patientReport.breakdown.gender && (
                      <Card>
                        ...
                        <div className="space-y-2">
                          {Object.entries(patientReport.breakdown.gender).map(([gender, count]) => (
                    ...
                    {patientReport.breakdown.ageGroups && (
                      <Card>
                        ...
                        <div className="space-y-2">
                          {Object.entries(patientReport.breakdown.ageGroups).map(([ageGroup, count]) => (
                ...
                {patientReport.timeSeries && patientReport.timeSeries.length > 0 && (
                  <Card>
                    ...
                    <div className="space-y-2">
                      {patientReport.timeSeries.slice(-10).map((item, index) => (
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {appointmentReport.breakdown.status && (
                      <Card>
                        ...
                        <div className="space-y-2">
                          {Object.entries(appointmentReport.breakdown.status).map(([status, count]) => (
                            <div key={status} className="flex justify-between">
                              <span className="text-gray-600 capitalize">{status}</span>
                              <span className="font-medium">{count}</span>
                            </div>
                    ...
                    {appointmentReport.breakdown.type && (
                      <Card>
                        ...
                        <div className="space-y-2">
                          {Object.entries(appointmentReport.breakdown.type).map(([type, count]) => (
                ...
                {appointmentReport.timeSeries && appointmentReport.timeSeries.length > 0 && (
                  <Card>
                    ...
                    <div className="space-y-2">
                      {appointmentReport.timeSeries.slice(-10).map((item, index) => (
                        <div key={index} className="flex justify-between items-center">
                          <span className="text-gray-600">{new Date(item.period).toLocaleDateString()}</span>
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {inventoryReport.breakdown.byType && (
                      <Card>
                        <h3 className="text-lg font-semibold mb-4">By Type</h3>
                        <div className="space-y-2">
                          {Object.entries(inventoryReport.breakdown.byType).map(([type, count]) => (
                            <div key={type} className="flex justify-between">
                              <span className="text-gray-600 capitalize">{type}</span>
                              <span className="font-medium">{count}</span>
                            </div>
                    ...
                    {inventoryReport.breakdown.byStatus && (
                      <Card>
                        <h3 className="text-lg font-semibold mb-4">By Status</h3>
                        <div className="space-y-2">
                          {Object.entries(inventoryReport.breakdown.byStatus).map(([status, count]) => (
                            <div key={status} className="flex justify-between">
                              <span className="text-gray-600 capitalize">{status}</span>
                              <span className="font-medium">{count}</span>
                            </div>
                ...
                {inventoryReport.lowStockItems && inventoryReport.lowStockItems.length > 0 && (
                  <Card>
                    ...
                    <div className="space-y-2">
                      {inventoryReport.lowStockItems.slice(0, 10).map((item, index) => (
