  ...
  return (
    <Layout>
      <div className='mb-8'>
        ...
        <p className='text-neutral-600 mt-2'>Manage clients, subscriptions, and system settings</p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
        ...
        <Card>
          <div className='p-6'>
            ...
            <p className='text-sm text-neutral-500 mt-2'>{stats?.totalSubscriptions || 0} total</p>
          </div>
        </Card>
