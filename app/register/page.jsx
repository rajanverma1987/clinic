          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="mt-12 space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">{t('auth.easySetup')}</h3>
                  <p className="text-purple-100">{t('auth.easySetupDesc')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">{t('auth.secureByDefault')}</h3>
                  <p className="text-purple-100">{t('auth.secureByDefaultDesc')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">{t('auth.support247')}</h3>
                  <p className="text-purple-100">{t('auth.support247Desc')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md">
          <div className="lg:hidden mb-8 text-center">
            <Link href="/" className="inline-flex items-center space-x-2">
              <div className="w-10 h-10 bg-gradient-to-br from-indigo-600 to-purple-800 rounded-lg flex items-center justify-center">
                <svg
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 animate-slide-up hover-lift">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl mb-4 animate-bounce-in">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                </svg>
              </div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">{t('auth.createAccount')}</h2>
              <p className="text-gray-600">{t('auth.getStartedTrial')}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-0 top-0 bottom-0 pr-3 flex items-center justify-center text-gray-400 hover:text-gray-600 z-10"
                  >
                    {showPassword ? (
              ...
              <Button type="submit" isLoading={isLoading} className="w-full hover-glow group" size="lg">
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button
                  type="button"
                  className="w-full inline-flex justify-center items-center px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:shadow-md transition-all duration-300 group"
                >
