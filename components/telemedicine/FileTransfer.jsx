  ...
  return (
    <div className="absolute right-0 top-0 h-full w-80 bg-gray-900 border-l border-gray-700 flex flex-col z-30">
      ...
      <div className="p-4 border-b border-gray-700 bg-gray-800">
        ...
        <label
          htmlFor="file-upload"
          className={`block w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-center cursor-pointer transition-colors ${
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-2">
        {files.length === 0 ? (
          ...
          files.map((file, index) => (
            <div
              key={index}
              className="bg-gray-800 rounded-lg p-3 flex items-center justify-between hover:bg-gray-700 transition-colors"
            >
