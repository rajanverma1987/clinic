...
import ClinicalNote, { NoteType } from '@/models/ClinicalNote.js';
 ...
 */
export async function createClinicalNote(input, tenantId, userId) {
  await connectDB();
 ...
 */
export async function getClinicalNoteById(noteId, tenantId, userId) {
  await connectDB();
 ...
 */
export async function listClinicalNotes(query, tenantId, userId) {
  await connectDB();
  ...
  return createPaginationResult(notes, total, page || 1, limit || 10);
}

/**
 * Update clinical note (creates new version)
 */
export async function updateClinicalNote(noteId, input, tenantId, userId) {
  await connectDB();
 ...
 */
export async function getNoteVersionHistory(noteId, tenantId, userId) {
  await connectDB();
 ...
 */
export async function deleteClinicalNote(noteId, tenantId, userId) {
  await connectDB();
