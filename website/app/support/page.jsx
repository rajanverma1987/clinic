      ...
      <main className='flex-1'>
          ...
          <div className='max-w-7xl mx-auto relative z-10'>
            <div className='text-center'>
              ...
              >
                ...
                <span>{t('support.support24_7')}</span>
              </div>
              <h1
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            >
              <Link
                ...
                style={{ padding: '32px' }}
              >
                <div className='absolute inset-0 bg-gradient-to-br from-primary-50 to-transparent opacity-0 group-hover:opacity-100' />
              ...
              <Link
                ...
                style={{ padding: '32px' }}
              >
                <div className='absolute inset-0 bg-gradient-to-br from-secondary-50 to-transparent opacity-0 group-hover:opacity-100' />
                <div className='relative z-10'>
                  <div
              ...
              <a
                href={`${CLINIC_APP_URL.replace(/\/$/, '')}/api-docs`}
                target='_blank'
                rel='noopener noreferrer'
                className='group relative bg-white border-2 border-neutral-200 rounded-2xl hover:border-primary-300 hover:shadow-xl overflow-hidden block'
                style={{ padding: '32px' }}
              >
                <div className='absolute inset-0 bg-gradient-to-br from-primary-50 to-transparent opacity-0 group-hover:opacity-100' />
                <div className='relative z-10'>
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            <div className='flex flex-col gap-8'>
              {faqs.map((category, categoryIndex) => (
                <div
                  key={categoryIndex}
                  className='bg-white rounded-2xl border border-neutral-200 shadow-sm hover:shadow-md p-8'
                >
                  <h3 className='text-neutral-900 border-b border-neutral-200 text-2xl font-bold mb-6 pb-4'>
                    {category.category}
                  </h3>
                      ...
                      return (
                        ...
                        >
                          <button
                            ...
                            className='w-full text-left flex items-center justify-between group hover:bg-neutral-50 px-6 py-5'
                          >
                            <div className='flex items-start flex-1'>
                              <div className='rounded-full bg-primary-100 flex items-center justify-center flex-shrink-0 group-hover:bg-primary-200 w-6 h-6 mr-4 mt-0.5'>
                                <svg
                              ...
                              <h4 className='text-neutral-900 font-semibold flex-1 group-hover:text-primary-600 text-lg'>
                                {faq.q}
                              </h4>
                            </div>
                          </button>
                          ...
                          >
                            <div className='pl-16 pr-6 pb-6'>
                              <div className='text-neutral-700 border-t border-neutral-100 pt-2 text-base leading-relaxed'>
                                {faq.a}
                              </div>
                            </div>
                          </div>
        ...
        >
          ...
          <div className='max-w-4xl mx-auto text-center relative z-10'>
            <div className='inline-flex items-center justify-center bg-white/20 backdrop-blur-sm rounded-2xl w-20 h-20 mb-6'>
              <svg
                className='text-white'
                fill='none'
                stroke='currentColor'
