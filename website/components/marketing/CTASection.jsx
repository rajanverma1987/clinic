...
export function CTASection() {
  return (
    <section className='relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden section-bg'>
      ...
      <div className='section-container relative z-10'>
        <div className='text-center mb-16'>
          <div className='inline-flex items-center bg-white border border-neutral-200 rounded-full px-4 py-1.5 mb-6 shadow-sm'>
            ...
            <span className='text-body-xs font-semibold text-neutral-700 tracking-wide uppercase'>
              24/7 Support Available
            </span>
          </div>

          <h2 className='section-title mb-6'>Get In Touch</h2>
          <p className='text-neutral-700 max-w-2xl mx-auto text-body-lg'>
            We&apos;re here to help. Reach out to us through any of these channels.
          </p>
        </div>

        <div className='content-grid-4 content-grid-gap-6 mb-12'>
          {[
            {
              title: 'Email',
              value: 'support@doctorsclinic.services',
              icon: <MailIcon className='icon icon-lg' />,
            ...
            },
            {
              ...
              icon: <PhoneIcon className='icon icon-lg' />,
            ...
            },
            {
              title: 'WhatsApp',
              value: '+1 (555) 123-4567',
              icon: <ChatIcon className='icon icon-lg' />,
            ...
            },
            {
              title: 'Inquiry Form',
              value: 'Contact Us',
              icon: <DocumentIcon className='icon icon-lg' />,
              link: '/contact',
              bgGradient: 'from-primary-100 to-primary-50',
              iconBg: 'bg-primary-500',
            },
            ...
            >
              ...
              <div
                ...
                style={{ background: 'var(--hero-shine-overlay)', zIndex: 1 }}
              />
        ...
        <div className='text-center mt-12'>
          ...
          <p className='mt-4 text-sm text-neutral-500 flex items-center justify-center gap-2'>
            <svg
              className='icon icon-xs text-primary-500'
              fill='none'
              stroke='currentColor'
              strokeWidth={2}
              viewBox='0 0 24 24'
            >
              <path
                strokeLinecap='round'
                strokeLinejoin='round'
                d='M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 019.618 4.056 11.955 11.955 0 01-2.166 9.001 11.955 11.955 0 01-7.452 4.056'
              />
            </svg>
