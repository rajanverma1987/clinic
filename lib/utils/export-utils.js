...
<body>
  ...
  ${
    ...
    <table>
      ...
      ${Object.entries(analytics.ageGroups)
        .map(([ageGroup, count]) => `<tr><td>${ageGroup}</td><td>${count}</td></tr>`)
        .join('')}
    </table>
  `
      : ''
  ...
  ${
    ...
    <table>
      ...
      ${Object.entries(analytics.genderCount)
        .map(([gender, count]) => `<tr><td>${gender}</td><td>${count}</td></tr>`)
        .join('')}
    </table>
  `
      : ''
