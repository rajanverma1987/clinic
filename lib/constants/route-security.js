...
export const TENANT_ISOLATION = {
  ...
  exceptions: ['/login', '/register', '/pricing', '/forgot-password', '/reset-password'],
...
/**
 * Returns true if the given path is forbidden for manager (cannotAccess).
 * Use in nav filtering and route guards.
 */
export function isManagerPathForbidden(path) {
...
/**
 * Whether the path is an exception to tenant enforcement (e.g. /login, /register).
 */
