...
export class VideoCallManager {
  ...
  handleConnect() {
    ...
    this.connectionManager.updateConnectionState('connected', 'Peer connection established');
    this.isCallActive = true;
    this.onConnectionChange({ status: 'connected' });
  }
  ...
  handleClose() {
    ...
    this.connectionManager.updateConnectionState('disconnected', 'Peer connection closed');
    this.isCallActive = false;
  ...
  async startScreenShare() {
    try {
      ...
      if (this.peerWrapper && this.peerWrapper.peer && this.peerWrapper.peer._pc) {
        ...
        const sender = this.peerWrapper.peer._pc.getSenders().find(s =>
