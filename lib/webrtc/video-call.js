        ...
        switch (message.type) {
          case 'offer':
            ...
            try {
              ...
              // This is critical - the answer must include the patient's video/audio tracks
              if (this.peerConnection.localStream) {
                ...
                console.log('[VideoCallManager] Checking local tracks:', {
                ...
                localTracks.forEach(track => {
                  ...
                  if (!hasTrack) {
                    console.log('[VideoCallManager] Adding missing local track:', track.kind);
              ...
              console.log('[VideoCallManager] ✅ Answer created with', this.peerConnection.peerConnection.getSenders().length, 'senders, sending to', message.from);
