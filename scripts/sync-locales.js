 ...
 * For any key missing in es.json or fr.json, copies the English value.
 * Preserves existing translations in es/fr.
...
function run() {
  ...
  console.log('Locale sync complete: es.json and fr.json now have 100% key parity with en.json.');
}
